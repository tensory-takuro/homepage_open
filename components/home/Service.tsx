                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    {services.map((service) => (
                        <Link
                            key={service.title}
                            href={service.href}
                            className="bg-white p-10 rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-3 hover:border-tensor-blue group flex flex-col items-center text-center relative overflow-hidden"
                        >
