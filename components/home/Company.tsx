                ...
                <div className="w-full border-t border-gray-200">
                    <dl className="divide-y divide-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-b border-gray-200">
                            <dt className="font-bold text-tensor-blue md:col-span-3 lg:col-span-2 text-lg">会社名</dt>
                            <dd className="text-gray-700 md:col-span-9 lg:col-span-10 text-lg font-medium">株式会社Tensory (Tensory Inc.)</dd>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-b border-gray-200">
                            <dt className="font-bold text-tensor-blue md:col-span-3 lg:col-span-2 text-lg">代表者</dt>
                            <dd className="text-gray-700 md:col-span-9 lg:col-span-10 text-lg font-medium">代表取締役 CEO 内野 琢郎</dd>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-b border-gray-200">
                            <dt className="font-bold text-tensor-blue md:col-span-3 lg:col-span-2 text-lg">資本金</dt>
                            <dd className="text-gray-700 md:col-span-9 lg:col-span-10 text-lg font-medium">2,000,000円</dd>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-b border-gray-200">
